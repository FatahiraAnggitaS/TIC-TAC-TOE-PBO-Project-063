...
class TTT1 extends JFrame implements ItemListener, ActionListener {
    ...
    public void showButton() {
        ...
        for (i = 0; i <= 8; i++, x += 200, j++) {
            ...
            b[i].setBackground(new Color(70, 134, 119));
        } //eof for

        reset = new JButton("RESET GAME");
        reset.setFont(new Font("Jokerman", Font.BOLD, 30));
        reset.setHorizontalAlignment(JLabel.CENTER);
        reset.setBounds(10, 620, 600, 70);
        reset.setBackground(new Color(63, 62, 63));
        reset.setForeground(new Color(246, 205, 157));
        add(reset);
    ...
    /*********************************************************/
    TTT1() {
        super("TIC-TAC-TOE edited by 2200018063");

        CheckboxGroup cbg = new CheckboxGroup();
        c1 = new Checkbox("vs computer", cbg, false);
        c2 = new Checkbox("vs friend", cbg, false);
        c1.setBounds(260, 300, 100, 40);
        c2.setBounds(260, 350, 100, 40);
        add(c1);
        add(c2);
        ...
        ic11 = new ImageIcon("x2.png");
        ic22 = new ImageIcon("o2.png");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (type == true) //logic-friend
        {
            ...
            if (e.getSource() == reset) {
                ...
                for (i = 0; i <= 7; i++)
                    for (j = 0; j <= 4; j++)
                        a[i][j] = a1[i][j]; //again initialing array
            } else { //comp logic
                for (i = 0; i <= 8; i++) {
                    if (e.getSource() == b[i]) {
                        if (b[i].getIcon() == null) {
        ...
        for (i = 0; i <= 7; i++) {
            ...
            if ((icon1 == icon2) && (icon2 == icon3) && (icon1 != null)) {
                if (icon1 == ic1) {
                    ...
                    JOptionPane.showMessageDialog(TTT1.this, "Jellyfish Win!! Click reset!!");
                    break;
                } else if (icon1 == ic2) {
                    b[(a[i][1] - 1)].setIcon(ic22);
                    b[(a[i][2] - 1)].setIcon(ic22);
                    b[(a[i][3] - 1)].setIcon(ic22);
                    JOptionPane.showMessageDialog(TTT1.this, "Nemo Win!! Click reset!!");
                    break;
                }
            }
        }
    } //eof action performed
